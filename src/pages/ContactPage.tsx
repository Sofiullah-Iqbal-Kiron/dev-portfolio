...
function ContactForm(){
    ...
    return (
        <form onSubmit={handleSubmit(onContactFormSubmit)} className="font-serif w-full sm:w-1/2 md:w-1/3 flex flex-col justify-center items-center space-y-5">
            <legend className="text-3xl text-center mb-8 sm:mb-5 font-black text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-pink-400">Let me know what kind of project you want</legend>
